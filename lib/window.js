...
function loadWindow(opts) {
  ...
  windowObject.webContents.on("new-window", (event, url) => {
    event.preventDefault();
    console.log('blocked new window: ' + url);
  });

  // @TODO: wait for 'will-frame-navigate' to be released (https://github.com/electron/electron/pull/34418)
  // @TODO: switch over to minimatch
  // windowObject.webContents.on(
  //   'will-frame-navigate',
